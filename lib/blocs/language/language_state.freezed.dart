...
mixin _$LanguageState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<LanguageModel> availableLanguages,
            LanguageModel knownLanguage, LanguageModel learningLanguage)
        loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<LanguageModel> availableLanguages,
            LanguageModel knownLanguage, LanguageModel learningLanguage)?
        loaded,
...
class __$$LoadedImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$LoadedImpl(
      ...
      knownLanguage: null == knownLanguage
          ? _value.knownLanguage
          : knownLanguage // ignore: cast_nullable_to_non_nullable
              as LanguageModel,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(
      {required final List<LanguageModel> availableLanguages,
  ...
  @override
  final LanguageModel knownLanguage;
  @override
  final LanguageModel learningLanguage;

  @override
  String toString() {
    return 'LanguageState.loaded(availableLanguages: $availableLanguages, knownLanguage: $knownLanguage, learningLanguage: $learningLanguage)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.knownLanguage, knownLanguage) ||
                other.knownLanguage == knownLanguage) &&
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(availableLanguages, knownLanguage, learningLanguage);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(availableLanguages, knownLanguage, learningLanguage);
  }
...
abstract class _Loaded implements LanguageState {
  const factory _Loaded(
      {required final List<LanguageModel> availableLanguages,
      required final LanguageModel knownLanguage,
      required final LanguageModel learningLanguage}) = _$LoadedImpl;

  List<LanguageModel> get availableLanguages;
  LanguageModel get knownLanguage;
...
class __$$ErrorImplCopyWithImpl<$Res>
    extends _$LanguageStateCopyWithImpl<$Res, _$ErrorImpl>
